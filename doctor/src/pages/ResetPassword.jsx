          ...
          <div className="mb-8 flex justify-between">
            <div className={`flex flex-col items-center`}>
              <div className={`flex h-10 w-10 items-center justify-center rounded-full font-bold text-white ${
                step === "email" || step === "code" || step === "newpassword" ? "bg-teal-600" : "bg-gray-300"
              }`}>
                1
              </div>
            ...
            <div className={`flex flex-1 items-center px-4`}>
              <div className={`h-1 flex-1 ${step === "code" || step === "newpassword" ? "bg-teal-600" : "bg-gray-300"}`} />
            </div>

            <div className={`flex flex-col items-center`}>
              <div className={`flex h-10 w-10 items-center justify-center rounded-full font-bold text-white ${
                step === "code" || step === "newpassword" ? "bg-teal-600" : "bg-gray-300"
              }`}>
                2
              </div>
            ...
            <div className={`flex flex-1 items-center px-4`}>
              <div className={`h-1 flex-1 ${step === "newpassword" ? "bg-teal-600" : "bg-gray-300"}`} />
            </div>

            <div className={`flex flex-col items-center`}>
              <div className={`flex h-10 w-10 items-center justify-center rounded-full font-bold text-white ${
                step === "newpassword" ? "bg-teal-600" : "bg-gray-300"
              }`}>
                3
              </div>
          ...
          {step === "code" && (
            <div className="space-y-6">
              ...
              <form onSubmit={(e) => { e.preventDefault(); setStep("newpassword"); }} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full rounded-xl bg-gradient-to-r from-teal-600 to-cyan-600 px-5 py-3 font-semibold text-white shadow-lg transition hover:from-teal-700 hover:to-cyan-700"
                >
                  Verify code
                </button>
              </form>
