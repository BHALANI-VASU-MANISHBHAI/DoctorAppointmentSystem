    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Manage and track your upcoming medical appointments</p>
        </div>
            ...
            <div className="bg-white rounded-xl p-5 shadow-sm border border-purple-100">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-900 mt-1">
                    {appointments.filter(a => a.status?.toLowerCase() !== 'cancelled' && a.status?.toLowerCase() !== 'completed').length}
                  </p>
                </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-12">
            <div className="flex flex-col items-center justify-center text-center">
              ...
              <p className="text-gray-600 mb-6 max-w-md">
                You haven't scheduled any appointments. Book your first appointment to get started with your healthcare journey.
              </p>
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-3 mb-2">
                          <h3 className="text-xl font-semibold text-gray-900">
                            Dr. {appointment.slot?.doctor?.user?.name || "Doctor"}
                          </h3>
                        ...
                        <div className="flex flex-wrap items-center gap-4 text-sm text-gray-600">
                          <div className="flex items-center gap-1.5">
                            ...
                            <span className="font-medium">{formatDate(appointment.slot?.date) || appointment.slot?.date}</span>
                          </div>
                        ...
                        {appointment.slot?.doctor?.specialization && (
                          <div className="mt-2 flex items-center gap-1.5 text-sm text-gray-500">
                            ...
                            <span>{appointment.slot?.doctor?.specialization}</span>
                          </div>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      <button
                        ...
                        disabled={cancelling === appointment.id || appointment.status?.toLowerCase() === 'cancelled'}
                      ...
                      <button className="px-5 py-2.5 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-all duration-200 shadow-sm hover:shadow flex items-center gap-2">
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
